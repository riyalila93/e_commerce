...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-03-13 | feat/ecommerce-enhancements | - | feat | Enhanced e-commerce features: Search, Cart quantity controls, Wishlist toggle, and Bootstrap UI. | antigravity | code | self-verified | manual | High | yes | no |
...
| 2026-03-16 | fix/product-image-loading | - | fix | Fixed product image loading by preferring valid local media files and restoring image rendering on the product detail page. | codex | code | self-verified | manual | Medium | yes | no |
